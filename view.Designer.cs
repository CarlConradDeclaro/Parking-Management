namespace Parking
{
    partial class view
    {
        ...
        private void InitializeComponent()
        {
            ...
            button1 = new Button();
            label11 = new Label();
            setArrivalDT = new Label();
            label3 = new Label();
            setParkoutDT = new Label();
            label5 = new Label();
            setAmt = new Label();
            label9 = new Label();
            setChanged = new Label();
            label13 = new Label();
            setHours = new Label();
            label14 = new Label();
            setCash = new Label();
            ...
            setArrivalDT.Text = "0/0/0 0:0:0:0 PM";
            // 
            // label3
            // 
            ...
            setParkoutDT.Text = "0/0/0 0:0:0:0 PM";
            // 
            // label5
            // 
        ...
        private Label setPlateNUm;
        private Label settype;
        private Label label4;
        private Label setBrand;
        private Label label6;
        private Label setDriver;
        private Label label8;
        private Label setPhone;
        private Label label10;
        private Button button1;
        private Label label11;
        private Label setArrivalDT;
        private Label label3;
        private Label setParkoutDT;
        private Label label5;
        private Label setAmt;
        private Label label9;
        private Label setChanged;
